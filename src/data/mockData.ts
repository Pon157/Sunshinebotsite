    ...
    music: [
      {
        ...
        title: "Нервы",
        artist: "Нервы",
        src: "/assets/music/Nervy_-_Nervy_48614944.mp3",
        coverUrl: "/assets/photos/photo_2026-07-05_09-52-55.jpg"
      },
      {
        id: "idar-2",
        title: "illusionary daytime",
        artist: "trackmaker",
        src: "/assets/music/Cherry_Hencefox_-_Illusionary_Daytime_x_Trackmaker_Douyin_81097640.mp3",
        coverUrl: "/assets/photos/photo_2026-07-05_09-52-55.jpg"
      }
    ]
  },
...
export const ADDITIONAL_TRACKS: Track[] = [
  {
    id: "add-1",
    title: "Питер Паркер",
    artist: "madk1d",
...
export const NAV_LINKS = [
  {
    ...
    url: "https://t.me/sunshinebott/11",
    description: "Официальный реестр действующей администрации и модераторов",
    type: "admin"
  },
  {
    id: "nav-rules",
    title: "Правила использования бота",
    url: "https://t.me/rulessunshinee",
    description: "Полноформатный свод правил поведения.",
    type: "rules"
  },
  {
    id: "nav-reviews",
    title: "Отзывы",
    url: "https://t.me/+6jm7JADhBsZmN2Qy",
    description: "Мнения участников, отзывы о поддержке и общении",
    type: "reviews"
  },
  {
    id: "nav-tiktok",
  ...
  },
  {
    id: "nav-chat",
    title: "Общалка (Chat)",
    url: "https://t.me/sunhinechatik",
    description: "Главный публичный чат Sunshine для живого и открытого общения",
    type: "chat"
  },
  {
    id: "nav-rests",
    title: "Список рестов и афк",
    url: "https://t.me/Sunshinertk",
    description: "График отдыха, активных отпусков и статусов нашей команды",
    type: "rests"
  },
  {
    id: "nav-promo",
  ...
  },
  {
    id: "nav-bot-link",
    title: "Наш бот",
    url: "http://t.me/Sunshine_1_bot",
    description: "Прямая ссылка для мгновенного запуска бота Sunshine",
    type: "bot"
  },
  {
    id: "nav-owner",
    title: "Связь с владельцем",
    url: "http://t.me/IdarDogov",
    description: "Личные контакты основателя по срочным вопросам и предложениям",
    type: "owner"
  },
  {
    id: "nav-manual",
    title: "Методичка для пользователя",
    url: "https://telegra.ph/Metodichka-dlya-polzovatelya-06-17",
    description: "Подробное руководство, команды бота и частые вопросы с ответами",
    type: "manual"
  }
];
